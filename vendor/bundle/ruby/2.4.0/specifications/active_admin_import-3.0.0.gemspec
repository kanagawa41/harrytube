# -*- encoding: utf-8 -*-
# stub: active_admin_import 3.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<activerecord-import>.freeze, ["~> 0.17.0"])
      ...
      s.add_dependency(%q<activerecord-import>.freeze, ["~> 0.17.0"])
